...
**Important update on 22/01/2026**: 
<font color="red">
We have updated the dataset to include new labels that include additional smooth skeletal sequences by doing post-processing on the original joint trajectories along temporal dimension.
Please refer to the <a href="https://cdehp-dataset.github.io/download">Download</a> page for more details.
</font>
...
## Visualization of Skeleton Sequences
